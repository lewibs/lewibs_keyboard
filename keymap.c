...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case ST_MACRO_3:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_F) SS_DELAY(KEY_PRESS_DELAY) SS_TAP(X_I) SS_DELAY(KEY_PRESS_DELAY) SS_TAP(X_L) SS_DELAY(KEY_PRESS_DELAY) SS_TAP(X_T) SS_DELAY(KEY_PRESS_DELAY) SS_TAP(X_E));
    }
    break;
    case ST_MACRO_4:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_S) SS_DELAY(KEY_PRESS_DELAY) SS_TAP(X_T) SS_DELAY(KEY_PRESS_DELAY) SS_TAP(X_R) SS_DELAY(KEY_PRESS_DELAY) SS_TAP(X_U) SS_DELAY(KEY_PRESS_DELAY) SS_TAP(X_C));
    }
    break;
    case ST_MACRO_5:
    if (record->event.pressed) {
    ...
    case ST_MACRO_14:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_F) SS_DELAY(KEY_PRESS_DELAY) SS_TAP(X_U) SS_DELAY(KEY_PRESS_DELAY) SS_TAP(X_N) SS_DELAY(KEY_PRESS_DELAY) SS_TAP(X_C));
    }
    break;
    case ST_MACRO_15:
    if (record->event.pressed) {
