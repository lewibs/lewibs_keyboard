...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [_BASE] = LAYOUT_planck_grid(
	...
	KC_LEFT_CTRL, KC_LEFT_ALT, MO(_LAYER5), KC_LEFT_SHIFT, MO(_LOWER), KC_SPACE, KC_NO, MO(_RAISE), MO(_LAYER4), MO(_LAYER6), KC_LEFT_GUI, KC_RIGHT_ALT
 ),

 [_LOWER] = LAYOUT_planck_grid(
	KC_Q, KC_Q, KC_Q, KC_Q, KC_Q, KC_TRANSPARENT, KC_TRANSPARENT, KC_NO, KC_EXLM, KC_LCBR, KC_RCBR, KC_AT, 
	KC_Q, KC_Q, KC_Q, KC_Q, KC_Q, KC_GRAVE, KC_TRANSPARENT, KC_NO, KC_HASH, KC_LPRN, KC_RPRN, KC_DLR, 
	KC_Q, KC_Q, KC_Q, KC_Q, KC_Q, LALT(LCTL(KC_T)), KC_TRANSPARENT, KC_NO, KC_PIPE, KC_LBRC, KC_RBRC, KC_AMPR, 
 ...
 [_LAYER4] = LAYOUT_planck_grid(
	...
	KC_NO, KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT, KC_NO, KC_NO, KC_TRANSPARENT, KC_Q, KC_LEFT, KC_DOWN, KC_RIGHT, KC_Q, 
